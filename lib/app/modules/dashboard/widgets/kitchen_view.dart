...
class KitchenView extends GetView<DashboardController> {
        ...
        children: [
          ...
          Expanded(
            child: Obx(() {
              ...
              return const AddStoreItemForm(category: "Kitchen");
            }),
          ),
        ],
      ),
  ...
  Widget _buildIncomingItems(BuildContext context) {
    return Column(
      ...
      children: [
        Text(
          "Kitchen Supplies Received (Stock In)",
          style: GoogleFonts.outfit(
            fontSize: 20,
        ...
        Container(
          ...
          child: TextField(
            decoration: InputDecoration(
              hintText: " Search kitchen stock in...",
                              ...
                              child: ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  return _IncomingCard(
                                    item: index % 3 == 0 ? "Cooking Oil (15L)" : (index % 3 == 1 ? "Rice (50kg Bag)" : "Spices Combo"),
                                    date: "May ${10 - (index % 10)}, 2024",
                                    qty: "${(index + 1) * 2} Units",
                ...
                Container(
                  ...
                  child: Wrap(
                    ...
                    children: [
                      ...
                      CustomPagination(currentPage: controller.inventoryPage, totalPages: 3),
                    ],
                  ),
                ),
              ],
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(flex: 2, child: _headerText("Section")),
                                  Expanded(flex: 2, child: _headerText("Date Issued")),
                              ...
                              child: ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  return _DistributionCard(
                                    item: index % 2 == 0 ? "Vegetables (Misc)" : "Cleaning Supplies",
                                    person: "Chef ${index + 1}",
                                    section: index % 2 == 0 ? "Main Kitchen" : "Dining Hall",
                                    issuedDate: "May 08, 2024",
                                    status: "Consumed",
                                  );
                                },
                              ),
      ...
      child: AnimatedContainer(
        ...
        child: Row(
          children: [
            ...
            Expanded(flex: 2, child: Text(widget.section, style: GoogleFonts.inter(color: AppColors.grey, fontSize: 13))),
            Expanded(flex: 2, child: Text(widget.issuedDate, style: GoogleFonts.inter(color: AppColors.grey))),
            Expanded(
              flex: 2,
              child: Container(
